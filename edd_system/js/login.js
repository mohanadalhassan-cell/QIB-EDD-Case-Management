...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getDashboardUrl(role) {
    const dashboards = {
      business: '/edd_system/business_view.html',
      cdd: '/edd_system/cdd_view.html',
      compliance: '/edd_system/compliance_view.html',
      management: '/edd_system/management_dashboard.html',
      audit: '/edd_system/audit_console.html',
      it: '/edd_system/dashboard.html'
    };
    return dashboards[role] || '/edd_system/dashboard.html';
  }
