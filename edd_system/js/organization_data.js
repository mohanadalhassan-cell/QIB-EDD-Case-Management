  ...
  operations: {
    ...
    managers: [
      ...
      },
      {
        ...
        name: 'Kader',
        name_ar: 'قادر',
        title: 'Department Manager - Remittance & ECC',
        title_ar: 'مدير إدارة - التحويلات',
        department: 'Remittance & ECC',
        dept_code: 'REMITTANCE',
        photo: 'assets/employees/Kader.jpeg',
        permissions: ['view_execute'],
        email: 'kader@qib.com.qa',
        reports_to: 'OPS-HEAD-001'
      },
      {
        id: 'MGR-004',
      ...
      {
        id: 'MGR-005',
        name: 'Hanaa Al-Khuzai',
        name_ar: 'هناء الخزاعي',
        title: 'Department Manager - Cards & Dividend',
        title_ar: 'مدير إدارة - البطاقات والأرباح',
        department: 'Cards & Dividend',
        dept_code: 'CARDS',
        photo: 'assets/employees/Hanaa.jpeg',
        permissions: ['view_execute'],
        email: 'hanaa.alkhuzai@qib.com.qa',
        reports_to: 'OPS-HEAD-001'
      },
      {
        id: 'MGR-006',
